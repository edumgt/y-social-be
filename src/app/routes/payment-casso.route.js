...
const { paymentCassoController } = require("../controllers/payment-casso.controller");
const router = express.Router();

router.get("/", paymentCassoController.getAll)
router.get('/user-info', paymentCassoController.getDetailUser)
router.post('/webhook/handler-bank-transfer', paymentCassoController.handlerBankTransfer)
